...
func (t *testFactoryBench) New(a, b gopacket131_dpdk.Flow, tcp *layers.TCP, ac AssemblerContext) Stream {
	return t
}
func (t *testFactoryBench) Accept(tcp *layers.TCP, ci gopacket131_dpdk.CaptureInfo, dir TCPFlowDirection, seq Sequence, start *bool, ac AssemblerContext) bool {
	return true
}
...
func (t *testFactory) New(a, b gopacket131_dpdk.Flow, tcp *layers.TCP, ac AssemblerContext) Stream {
	return t
}
...
func (t *testFactory) Accept(tcp *layers.TCP, ci gopacket131_dpdk.CaptureInfo, dir TCPFlowDirection, seq Sequence, start *bool, ac AssemblerContext) bool {
	return true
}
...
func (tf *testMemoryFactory) New(a, b gopacket131_dpdk.Flow, tcp *layers.TCP, ac AssemblerContext) Stream {
	return tf
}
func (tf *testMemoryFactory) Accept(tcp *layers.TCP, ci gopacket131_dpdk.CaptureInfo, dir TCPFlowDirection, seq Sequence, start *bool, ac AssemblerContext) bool {
	return true
}
...
func testFlush(t *testing.T, s []testSequence, delay time.Duration, flushInterval time.Duration) {
	...
	for i, test := range s {
		...
		test.in.SetInternalPortsForTesting()
		ctx := assemblerSimpleContext(gopacket131_dpdk.CaptureInfo{Timestamp: simTime})
...
func (tkf *testKeepFactory) New(a, b gopacket131_dpdk.Flow, tcp *layers.TCP, ac AssemblerContext) Stream {
	return tkf
}
...
func (tkf *testKeepFactory) Accept(tcp *layers.TCP, ci gopacket131_dpdk.CaptureInfo, dir TCPFlowDirection, seq Sequence, start *bool, ac AssemblerContext) bool {
	return true
}
...
func (t *testFSMFactory) New(a, b gopacket131_dpdk.Flow, tcp *layers.TCP, ac AssemblerContext) Stream {
	return t
}
...
func (t *testFSMFactory) Accept(tcp *layers.TCP, ci gopacket131_dpdk.CaptureInfo, dir TCPFlowDirection, seq Sequence, start *bool, ac AssemblerContext) bool {
...
func (seq *testFSMSequence) GetCaptureInfo() gopacket131_dpdk.CaptureInfo {
	return seq.ci
}
...
func (t *testMemoryContext) GetCaptureInfo() gopacket131_dpdk.CaptureInfo {
...
func (c testCustomContext) GetCaptureInfo() gopacket131_dpdk.CaptureInfo {
	// We're just abusing the InterfaceIndex to identify the context, no other
	// meaning here.
	return gopacket131_dpdk.CaptureInfo{InterfaceIndex: int(c)}
}
