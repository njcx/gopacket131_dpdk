...
var memLog = flag.Bool("assembly_memuse_log", false, "If true, the github.com/njcx/gopacket131_dpdk/tcpassembly library will log information regarding its memory use every once in a while.")
var debugLog = flag.Bool("assembly_debug_log", false, "If true, the github.com/njcx/gopacket131_dpdk/tcpassembly library will log verbose debugging information (at least one line per packet)")
...
type StreamFactory interface {
	...
	New(netFlow, tcpFlow gopacket131_dpdk.Flow) Stream
}
...
func (a *Assembler) AssembleWithTimestamp(netFlow gopacket131_dpdk.Flow, t *layers.TCP, timestamp time.Time) {
