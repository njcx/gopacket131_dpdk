...
types of packet layers.  Users of gopacket131_dpdk will almost always want to also use
layers to actually decode packet data into useful pieces. To see the set of
protocols that gopacket131_dpdk/layers is currently able to decode,
...
gopacket131_dpdk.Decoder interface, so they can be passed into gopacket131_dpdk as decoders.
...
http://github.com/njcx/gopacket131_dpdk.
...
this:
	...
	var mySpiffyIPv4Decoder gopacket131_dpdk.Decoder = ...
...
packets, instead of the built-in decoder used by gopacket131_dpdk.
*/
package layers
